...
<link rel="stylesheet" href="{{url::to('/js/jquery-2.2.3.min.js')}}">
<!-- jQuery UI 1.11.4 -->
<script src="https://code.jquery.com/ui/1.11.4/jquery-ui.min.js"></script>
<!-- Bootstrap 3.3.6 -->
<link rel="stylesheet" href="{{url::to('bootstrap/js/bootstrap.min.js')}}">
...
<!-- AdminLTE App -->
<link rel="stylesheet" href="{{url::to('js/app.min.js')}}">
